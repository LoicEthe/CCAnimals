...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=ResetPassword::class, mappedBy="user_id")
     */
    ...
    public function removeResetPassword(ResetPassword $resetPassword): self
    {
        if ($this->resetPasswords->removeElement($resetPassword)) {
            ...
            if ($resetPassword->getUserId() === $this) {
                $resetPassword->setUserId(null);
            }
        }
